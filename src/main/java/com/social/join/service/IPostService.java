...
public interface IPostService {
     ...
     *
     * @param postUpdateRequest @return the  {@link Optional} of {@link PostDTO} instance that we want to be updated to
     * @param id
     */
    Optional<PostDTO> updatePost(PostUpdateRequest postUpdateRequest, int id);
