...
public class CommentServiceImplTest {
        ...
        void createComment() {
            ...
            testComment.setUpdateDate(null);

            CommentCreateRequest commentToSave = commentMapper.commentDTOToCommentCreateRequest(testComment);

            // Act
            CommentDTO returnedComment = commentService.createComment(commentToSave);
        ...
        private void assertCommentEquality(CommentDTO actualComment, CommentDTO expectedComment, boolean checkID) {
            ...
            assertThat(expectedComment.getUpdateDate()).isNotNull();
